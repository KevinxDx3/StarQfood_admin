@php
    ...
    $CategoryRest = '/admin/category/restaurant';
    $CategoryFood = '/admin/category/food';
    $RestaurantsUrl = '/admin/restaurants';
    $RestCreateUrl = '/admin/restaurants/create';
...
<body>
    ...
    <body id="body-pd">
        <header class="d-block header bg-light" id="header">
            <div class="row align-items-center ">
                <div class=" d-flex justify-content-evenly col-6 col-md-3 col-xl-2 header_toggle ps-4 ps-md-2 pt-1" >
                    <i class='bx bx-menu' id="header-toggle"><small class="align-items-center" style="font-family: sans-serif">   Menú</small></i>
                </div>
                <div class="col-6 col-md-6 col-xl-8 text-center pt-1">
        ...
        <div class="l-navbar" id="nav-bar">
            <nav class="nav2 ">
                <div class="pe-0">
                    <a href={{ $homeUrl }} class="nav_logo  active2  ps-2 pe-5 ">
                    ...
                    <div class="nav_list">
                        <a href={{ $homeUrl }} class="nav_link2 m-0"> <i class='bx bx-home nav_icon me-2'></i>
                        ...
                        <div class="accordion accordion-flush p-0 m-0" id="accordionMenu">
                            <div class=" accordion-item p-0 m-0 mt-2 mb-1" style="background: #18181a">
                                <div class="accordion-header  " id="flush-headingUsers">
                                    <button class="nav_link2 d-flex accordion-button dack collapsed ps-3 pe-2 m-0 w-100"
                                ...
                                <div id="flush-collapseUsers" style="background: #242427"
                                    ...
                                    <div class="accordion-body p-0 m-0 ">
                                        <a href={{ $userUrl }} class="nav_link2 m-0"> <i
                                                class='bx bxs-group nav_icon me-2'></i>
                                            <span class="nav_name">Index</span>
                                        </a>
                                        <a href={{ $userCreateUrl }} class="nav_link2 m-0"> <i
                            ...
                            <div class=" accordion-item p-0 m-0 mt-2 mb-1" style="background: #18181a">
                                ...
                                <div id="flush-collapseCategory" style="background: #242427"
                                    ...
                                    <div class="accordion-body p-0 m-0 ">
                                        <a href={{ $CategoryRest }} class="nav_link2 m-0"> <i
                                                class='bx bx-restaurant nav_icon me-2'></i>
                                            <span class="nav_name">Restaurantes</span>
                                        </a>
                                        <a href={{ $CategoryFood }} class="nav_link2 m-0"> <i
                            ...
                            <div class=" accordion-item p-0 m-0 mt-2 mb-1" style="background: #18181a">
                                ...
                                <div id="flush-collapseRestaur" style="background: #242427"
                                    ...
                                    data-bs-parent="#accordionMenu">
                                    <div class="accordion-body p-0 m-0 ">
                                        <a href={{ $RestaurantsUrl }} class="nav_link2 m-0"> <i
                                                class='bx bx-list-ul nav_icon me-2'></i>
                                            <span class="nav_name">Index</span>
                                        </a>
                                        <a href={{ $RestCreateUrl }} class="nav_link2 m-0"> <i
                            ...
                            <div class=" accordion-item p-0 m-0 mt-2 mb-1" style="background: #18181a">
                                ...
                                <div id="flush-collapseFood" style="background: #242427" class="accordion-collapse collapse m-0 p-0" aria-labelledby="flush-headingFood" data-bs-parent="#accordionMenu">
                                    <div class="accordion-body p-0 m-0 " >
                                        <a href={{$FoodsUrl}} class="nav_link2 m-0"> <i class='bx bx-food-menu nav_icon me-2'></i>
                                            <span class="nav_name">Index</span>
                                        </a>
                                        <a href={{$FoodsCreateUrl}} class="nav_link2 m-0"> <i class='bx bxs-book-add nav_icon me-2'></i>
                             ...
                             <div class=" accordion-item p-0 m-0 mt-2 mb-1" style="background: #18181a">
                                <div class="accordion-header" id="flush-headingMap">
                                    <button class="nav_link2 d-flex accordion-button dack collapsed ps-3 pe-2 m-0 w-100" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseMap" aria-expanded="false" aria-controls="flush-collapseMap" >
                        ...
                        <div class="accordion accordion-flush d-md-none " id="menuaUser">
                            <div class="accordion-item">
                                <div class="accordion-header p-0" id="flush-headingUser">
                                    <a class="d-flex accordion-button collapsed m-0 p-0 ps-3 pe-1 nav_link2"
                                ...
                                <div id="flush-collapseUser" class="accordion-collapse collapse p-0 m-0"
                                    ...
                                    <div class="accordion-body m-0 p-0" style="background: #18181a">
                                        <ul class="list-unstyled text-light p-0 pt-2">
                                            <li>
                                                <a class="nav_link2" href={{ $profileUrl }}>
                                                    <i class='bx bx-user nav_icon'></i><span
                                                        class="nav_name ms-3">Perfil</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a class="nav_link2" href={{ $editProfileUrl }}>
                                            ...
                                            <hr>
                                            <li>
                                                <a class="nav_link2" href={{ $logOutUrl }} onclick="event.preventDefault(); document.getElementById('logout-form').submit();" >
                ...
                <div class="nav_list">
                    <a href={{$logOutUrl}} class="nav_link2" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"> <i class='bx bx-log-out nav_icon'></i> <span
